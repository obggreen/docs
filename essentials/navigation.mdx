...
```bash cURL
curl -X POST https://platform.runblob.io/api/veo/generate \
...
response = requests.post(
    "https://platform.runblob.io/api/veo/generate",
    headers=headers,
    json=payload
)
...
const response = await fetch('https://platform.runblob.io/api/veo/generate', {
  method: 'POST',
  headers: headers,
