...
| Feature | Google Veo3 | Kling AI | Sora 2 |
|---------|-------------|----------|--------|
| Text-to-Video | Yes | Yes (most versions) | Yes |
| Image-to-Video | Yes | Yes | Yes |
| Frame-to-Frame | Yes | No | No |
| Reference Images | Yes | No | No |
| Negative Prompts | No | Yes (1.6, 2.1) | No |
| CFG Scale | No | Yes (1.6 only) | No |
| Orientation Control | Limited | Limited | 9:16, 16:9 |
| Duration Options | 5s, 10s | 5s, 10s | 10s, 15s |
| Generation Time | 1-10 min | 2-5 min | 5-15 min |
| Authentication | Bearer Token | Bearer Token | Bearer Token |
| Best For | High quality, complex scenes | Speed, creative control | Portrait/landscape, OpenAI quality |

<Note>
  **Ready to start?** Generate your first video with our [quickstart guide](/quickstart) or explore the API documentation for [Veo3](/api-reference/veo3/generate), [Kling AI](/api-reference/kling/generate), or [Sora 2](/api-reference/sora/generate).
</Note>
