...
<ParamField path="input_images" type="array">
...
curl -X POST https://platform.runblob.io/v1/o1-photo/generate \
...
response = requests.post(
    "https://platform.runblob.io/v1/o1-photo/generate",
    headers={
...
<AccordionGroup>
  <Accordion icon="images" title="Reference Images">
    **Use up to 5 input images:**
    - Provide URLs of reference images
