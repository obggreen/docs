...
### Check Photo Status
```bash
curl -X GET https://platform.runblob.io/v1/o1-photo/status/GENERATION_ID \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
const photoResponse = await fetch('https://platform.runblob.io/v1/o1-photo/generate', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY',
    'Content-Type': 'application/json'
...
// With reference images
const photoWithRefsResponse = await fetch('https://platform.runblob.io/v1/o1-photo/generate', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY',
    'Content-Type': 'application/json'
