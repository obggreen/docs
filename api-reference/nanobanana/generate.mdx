...
description: "Create images from text prompts using Nano Banana (Gemini). Models: Standard, Pro, and V2 (Nano Banana 2)."
---
...
```bash Nano Banana 2 (V2)
curl -X POST https://platform.runblob.io/v1/gemini/generate \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "prompt": "A futuristic space station orbiting Mars",
    "model": "v2",
    "quality": "2k",
    "aspect_ratio": "16:9"
  }'
