...
| Model | Quality | Price | Description |
|-------|---------|-------|-------------|
| `standard` | - | $0.02 | Fast generation, good quality |
| `pro` | standard | $0.04 | Higher quality |
| `pro` | 2k | $0.05 | 2K resolution |
| `pro` | 4k | $0.08 | 4K resolution |
